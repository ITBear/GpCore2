...
using unix_ts_ms_t  = GpUnit<s_int_64, 1, GpUnitType_UNIX_TIMESTAMP, std::milli,        decltype("unix_ts_ms"_template_str)>;
using unix_ts_s_t   = GpUnit<s_int_64, 1, GpUnitType_UNIX_TIMESTAMP, std::ratio<intmax_t(1), intmax_t(1)>, decltype("unix_ts_s"_template_str)>;
