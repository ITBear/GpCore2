...
using frequency_Hz_t    = GpUnit<s_int_64, 1, GpUnitType_SI_FREQUENCY, std::ratio<intmax_t(1), intmax_t(1)>, decltype("Hz"_template_str)>;
using frequency_kHz_t   = GpUnit<s_int_64, 1, GpUnitType_SI_FREQUENCY, std::kilo                            , decltype("KHz"_template_str)>;
using frequency_MHz_t   = GpUnit<s_int_64, 1, GpUnitType_SI_FREQUENCY, std::mega                            , decltype("MHz"_template_str)>;
using frequency_GHz_t   = GpUnit<s_int_64, 1, GpUnitType_SI_FREQUENCY, std::giga                            , decltype("GHz"_template_str)>;
