...
public:
    ...
    constexpr size_t                    Leading0bitCnt      (void) const noexcept;
    constexpr size_t                    Trailing0bitCnt     (void) const noexcept;
...
template<typename MaskT,
         typename ValueT> constexpr
size_t  GpBitset<MaskT, ValueT>::Leading0bitCnt (void) const noexcept
{
    return BitOps::Leading0bitCnt(Value());
}

template<typename MaskT,
         typename ValueT> constexpr
size_t  GpBitset<MaskT, ValueT>::Trailing0bitCnt (void) const noexcept
{
    return BitOps::Trailing0bitCnt(Value());
}
