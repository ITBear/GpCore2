...
#       define GP_OS_NAME "Windows"
#   elif defined(ANDROID) || defined(__ANDROID__)
#       define GP_OS_ANDROID
#       define GP_OS_NAME "Android"
#       define GP_POSIX
#   elif defined(__linux__)
#       define GP_OS_LINUX
#       define GP_OS_NAME "Linux"
#       define GP_POSIX
#   elif defined(TARGET_OS_IPHONE) && (TARGET_OS_IPHONE == 1)
#       define GP_OS_IOS
#       define GP_OS_NAME "iOS"
#       define GP_POSIX
