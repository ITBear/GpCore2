...
public:
    ...
    std::map<u_int_8, std::string, std::less<>>             map_ui8_str;
...
public:
    ...
    std::map<s_int_8, std::string, std::less<>>         map_si8_str;
...
public:
    ...
    std::map<u_int_16, std::string, std::less<>>            map_ui16_str;
...
public:
    ...
    std::map<s_int_16, std::string, std::less<>>            map_si16_str;
...
public:
    ...
    std::map<u_int_32, std::string, std::less<>>            map_ui32_str;
...
public:
    ...
    std::map<s_int_32, std::string, std::less<>>            map_si32_str;
...
public:
    ...
    std::map<u_int_64, std::string, std::less<>>            map_ui64_str;
...
public:
    ...
    std::map<s_int_64, std::string, std::less<>>            map_si64_str;
...
public:
    ...
    std::map<unix_ts_s_t, std::string, std::less<>>         map_utss_str;
...
public:
    ...
    std::map<unix_ts_ms_t, std::string, std::less<>>            map_utsms_str;
...
public:
    ...
    std::map<float, std::string, std::less<>>               map_float_str;
...
public:
    ...
    std::map<double, std::string, std::less<>>              map_double_str;
...
public:
    ...
    std::map<GpUUID, std::string, std::less<>>              map_uuid_str;
...
public:
    std::map<std::string, u_int_8, std::less<>>             map_str_ui8;
    std::map<std::string, s_int_8, std::less<>>             map_str_si8;
    std::map<std::string, u_int_16, std::less<>>                map_str_ui16;
    std::map<std::string, s_int_16, std::less<>>                map_str_si16;
    std::map<std::string, u_int_32, std::less<>>                map_str_ui32;
    std::map<std::string, s_int_32, std::less<>>                map_str_si32;
    std::map<std::string, u_int_64, std::less<>>                map_str_ui64;
    std::map<std::string, s_int_64, std::less<>>                map_str_si64;
    std::map<std::string, unix_ts_s_t, std::less<>>         map_str_uts_s;
    std::map<std::string, unix_ts_ms_t, std::less<>>            map_str_uts_ms;
    std::map<std::string, float, std::less<>>                   map_str_real_f;
    std::map<std::string, double, std::less<>>                  map_str_real_d;
    std::map<std::string, bool, std::less<>>                    map_str_b;
    std::map<std::string, GpUUID, std::less<>>                  map_str_uuid;
    std::map<std::string, std::string, std::less<>>         map_str_str;
    std::map<std::string, GpBytesArray, std::less<>>            map_str_blob;
    std::map<std::string, GpReflectDemoDesc::SP, std::less<>>   map_str_s2;
};
...
public:
    ...
    std::map<GpBytesArray, std::string, std::less<>>            map_bytes_str;
