...
//1 bit
using size_mebibit_t    = GpUnit<u_int_64, GpUnitType_MEBIBYTES_SIZE, std::ratio<intmax_t(1), intmax_t(1)>, decltype("bit"_template_str)>;

//1 byte
using size_mebibyte_t   = GpUnit<u_int_64, GpUnitType_MEBIBYTES_SIZE, std::ratio<intmax_t(1)*intmax_t(8), intmax_t(1)>, decltype("byte"_template_str)>;
