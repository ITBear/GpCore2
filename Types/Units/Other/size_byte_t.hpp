...
//1 bit
using size_bit_t    = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1), intmax_t(1)>, decltype("bit"_template_str)>;

//1 byte
using size_byte_t   = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1)*intmax_t(8), intmax_t(1)>, decltype("byte"_template_str)>;

//10^3 = 1000 bytes
using size_kB_t = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1'000)*intmax_t(8), intmax_t(1)>, decltype("kB"_template_str)>;

//10^6 = 1 000 000 bytes
using size_MB_t = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1'000'000)*intmax_t(8), intmax_t(1)>, decltype("MB"_template_str)>;

//10^9 = 1 000 000 000 bytes
using size_GB_t = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1'000'000'000)*intmax_t(8), intmax_t(1)>, decltype("GB"_template_str)>;

//10^12 = 1 000 000 000 000 bytes
using size_TB_t = GpUnit<s_int_64, GpUnitType_BYTES_SIZE, std::ratio<intmax_t(1'000'000'000'000)*intmax_t(8), intmax_t(1)>, decltype("TB"_template_str)>;
