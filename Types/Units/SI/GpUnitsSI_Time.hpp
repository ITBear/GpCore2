...
using minutes_t         = GpUnit<double, GpUnitType_SI_TIME, std::ratio<intmax_t(60000000), intmax_t(1)>,   decltype("minutes"_template_str)>;
using hours_t           = GpUnit<double, GpUnitType_SI_TIME, std::ratio<intmax_t(3600000000), intmax_t(1)>, decltype("hours"_template_str)>;
