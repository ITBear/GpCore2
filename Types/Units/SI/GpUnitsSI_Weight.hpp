...
using picoGrams_t	= GpUnit<double, GpUnitType_SI_WEIGHT, std::pico,							decltype("pg"_template_str)>;
using nanoGrams_t	= GpUnit<double, GpUnitType_SI_WEIGHT, std::nano,							decltype("ng"_template_str)>;
using microGrams_t	= GpUnit<double, GpUnitType_SI_WEIGHT, std::micro,							decltype("ug"_template_str)>;
using milliGrams_t	= GpUnit<double, GpUnitType_SI_WEIGHT, std::milli,							decltype("mg"_template_str)>;
using grams_t		= GpUnit<double, GpUnitType_SI_WEIGHT, std::ratio<intmax_t(1), intmax_t(1)>,decltype("g"_template_str)>;
using kiloGrams_t	= GpUnit<double, GpUnitType_SI_WEIGHT, std::kilo,							decltype("kg"_template_str)>;
