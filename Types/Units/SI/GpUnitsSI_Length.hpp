...
using picometers_t  = GpUnit<double, GpUnitType_SI_LENGTH, std::pico                            , decltype("pm"_template_str)>;
using nanometers_t  = GpUnit<double, GpUnitType_SI_LENGTH, std::nano                            , decltype("nm"_template_str)>;
using micrometers_t = GpUnit<double, GpUnitType_SI_LENGTH, std::micro                           , decltype("um"_template_str)>;
using millimeters_t = GpUnit<double, GpUnitType_SI_LENGTH, std::milli                           , decltype("mm"_template_str)>;
using centimeters_t = GpUnit<double, GpUnitType_SI_LENGTH, std::centi                           , decltype("cm"_template_str)>;
using decimeters_t  = GpUnit<double, GpUnitType_SI_LENGTH, std::deci                            , decltype("dm"_template_str)>;
using meters_t      = GpUnit<double, GpUnitType_SI_LENGTH, std::ratio<intmax_t(1), intmax_t(1)> , decltype("m"_template_str)>;
using kilometers_t  = GpUnit<double, GpUnitType_SI_LENGTH, std::kilo                            , decltype("km"_template_str)>;
